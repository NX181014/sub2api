export default {
  sharedPool: {
    ...
    settlement: {
      title: 'Current Account AA', formula: 'Use live cost and usage from active accounts to generate direct member-to-member net transfers', usageWeight: 'Priced Usage', totalCost: 'Period Cost', carryForward: 'Carry Forward', coverage: 'Pricing Coverage', unpricedWarning: '{count} usage records are unpriced, so the current allocation may be incomplete.', payable: 'Payable', receivable: 'Receivable', balanced: 'No transfer',
      transferPreview: 'Combined Transfers', transferWorkbench: 'AA Transfer Workbench', hubHint: 'The live balance is automatically matched into direct member-to-member transfers.', autoNetting: 'Live direct matching', autoNettingHint: 'Current active accounts, cost and usage are recalculated before payment.', settlementUser: 'Settlement User', pendingMembers: 'Members Pending', pendingAmount: 'Pending Amount', singleTransferHint: 'Each row is one direct transfer. Deleted accounts leave the live plan immediately.', pendingSummary: '{count} transfers pending', allSettled: 'Period fully settled', transferList: 'Transfer List', transferDirection: 'Direction', transferAmount: 'Amount', pendingTransfer: 'Pending', settled: 'Settled', handleTransfer: 'Handle Transfer', payer: 'Payer', payee: 'Payee', allocationDetails: 'Account Allocation Details', copyTitle: 'AA Transfer', copyTransfer: 'Copy Transfer Info', copied: 'Transfer information copied', markTransferPaid: 'Transferred and Settled', memberSettled: 'Transfer settled',
      transferSummary: '{count} transfers · {total}', accountFallback: 'Account #{id}', noTransfers: 'No net balance currently requires a transfer', lock: 'Lock Settlement', lockTitle: 'Lock Settlement', lockMessage: 'Amounts and calculation snapshots stay fixed after locking. Confirm the period data first.', lockedSuccess: 'Settlement locked', pendingConfirmations: '{count} member confirmations pending', pendingForYou: 'Shared-pool bills awaiting confirmation', pendingForYouHint: 'Check the period and amount. Administrators can settle only after every member confirms.', confirmationNotRequired: 'Not required', pending: 'Pending', confirmed: 'Confirmed', confirmMine: 'Confirm my bill', resolveMember: 'Confirm member', confirmedSuccess: 'Settlement line confirmed', markPaid: 'Mark paid', markPaidTitle: 'Mark settlement paid', markPaidMessage: 'All non-zero member lines are confirmed. Mark this settlement paid?', markedPaidSuccess: 'Settlement marked paid'
    },
    sources: { title: 'Purchase Source Quality', chartTitle: 'Payback and 30-Day Ban Rate', sampleHint: 'Review source status, contributors, currency, and cost performance together; open history for full records', smallSample: 'Small sample', costRule: 'Cost / Survival', days: 'days', history: 'View history', locateRecords: 'Locate pool records' },
    ...
    approval: {
      ...
      groups: { identity: 'Account identity and ownership', visibility: 'Visibility', scheduling: 'Scheduling', capacity: 'Capacity', cost_settlement: 'Cost and settlement', linked_data: 'Related data', credentials: 'Credentials' },
		impacts: { accounts: 'Accounts', credential_keys: 'Credential keys', scheduling_records: 'Scheduling records', cost_entries: 'Cost entries', settlements: 'Affected settlements', settlement_account_costs: 'AA account cost rows', settlement_account_lines: 'AA account allocation rows', mixed_settlements: 'Mixed settlements', empty_settlements: 'Empty settlements', purchase_sources: 'Purchase sources', group_links: 'Group links', lifecycle_events: 'Lifecycle records', retained_usage_records: 'Retained usage records' },
      effects: { identity_changed: 'Account identity or ownership information will change', visibility_changed: 'Account visibility or group scope will change', scheduling_changed: 'Account scheduling behavior will change', capacity_changed: 'Capacity and payback calculations will change', settlement_changed: 'Cost or AA settlement inputs will change', linked_data_changed: 'Related business data will change', credential_replacement: 'Credentials will be updated while values remain hidden', credential_access: 'The requester can reveal credentials once after approval', permanent_cleanup: 'The account and related business data will be permanently removed' },
		updated: 'Updated', showRemaining: 'Show {count} more', technicalDetails: 'Technical details', deleteImpactTitle: 'Related data changes after execution',
