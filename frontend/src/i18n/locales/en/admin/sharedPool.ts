export default {
  sharedPool: {
    ...
    settlement: {
      title: 'Current Account AA', formula: 'Keep full account allocations while netting each member into one transfer with the settlement user', usageWeight: 'Priced Usage', totalCost: 'Period Cost', carryForward: 'Carry Forward', coverage: 'Pricing Coverage', unpricedWarning: '{count} usage records are unpriced, so the current allocation may be incomplete.', payable: 'Payable', receivable: 'Receivable', balanced: 'No transfer',
      transferPreview: 'Combined Transfers', transferWorkbench: 'AA Transfer Workbench', hubHint: 'Choose a settlement user so every member needs at most one transfer while all account allocations remain available.', settlementUser: 'Settlement User', pendingMembers: 'Members Pending', pendingAmount: 'Pending Amount', singleTransferHint: 'One member, period, and currency can be settled with one transfer.', pendingSummary: '{count} transfers pending', allSettled: 'Period fully settled', transferList: 'Transfer List', transferDirection: 'Direction', transferAmount: 'Amount', pendingTransfer: 'Pending', settled: 'Settled', handleTransfer: 'Handle Transfer', payer: 'Payer', payee: 'Payee', allocationDetails: 'Account Allocation Details', copyTitle: 'AA Transfer', copyTransfer: 'Copy Transfer Info', copied: 'Transfer information copied', markTransferPaid: 'Transferred and Settled', memberSettled: 'Member settled',
