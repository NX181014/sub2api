export default {
  sharedPool: {
    ...
    delete: {
      costDisposition: 'Remaining Cost Treatment', costDispositionHint: 'Only unrecovered cost is handled; recognized usage value is not counted twice.',
		writeOff: 'Write off as loss', refund: 'Record refund', transfer: 'Transfer to replacement', replacementAccount: 'Replacement Account', refundAmount: 'Actual Refund Amount', refundAmountHint: 'Enter the amount received. Any unrecovered balance not refunded is recorded as a ban loss.',
		reason: 'Deletion Reason', reasonHint: 'Required; record the ban, expiry, or replacement reason', auditHint: 'Runtime data is cleaned while existing cost, usage, approval, and settlement records remain available for audit.',
		loadAccountsFailed: 'Failed to load replacement accounts', bulkRequiresIndividual: '{count} accounts are selected. Delete them individually because each account may need a different remaining-cost treatment.', approvalSubmitted: 'Deletion request submitted for another administrator to review', success: 'Account deleted and related data handled', failed: 'Failed to delete account'
    },
    approval: {
      ...
      credentialTitle: 'Account credentials · {name}', credentialHint: 'Enter the purpose. The requester, reviewer, purpose, and access time are audited.', primaryDirectHint: 'The primary administrator can view directly; this access is still audited.',
