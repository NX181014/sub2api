export default {
    accounts: {
      ...
      dataExportIncludeProxies: 'Export proxy connection details separately from Proxy Management after peer approval.',
      dataImport: 'Import',
      moreActions: 'More Actions',
      dataActions: 'Data',
      toolActions: 'Tools',
      viewColumns: 'Columns',
      toolsDialog: { title: 'Workbench tools' },
      actionDialog: {
        title: 'Account actions',
        common: 'Common actions',
        maintenance: 'Account maintenance',
        platform: 'Platform capabilities',
        data: 'Data and approvals',
        danger: 'Danger zone',
        deleteHint: 'Deletion continues through the existing confirmation flow with the account impact shown.'
      },
      display: {
        ...
        finance: 'Finance',
        full: 'Full',
        secondary: 'Show source, groups, and secondary details',
        density: 'Density',
        comfortable: 'Comfortable',
        compact: 'Compact',
        order: 'Module order',
        usageFirst: 'Usage first',
        financeFirst: 'Finance first',
        modules: 'Visible modules and order',
        module: {
          identity: 'Identity and type',
          runtime: 'Status and scheduling',
          usage: 'Usage',
          finance: 'Finance',
          source: 'Source / groups / proxy',
          actions: 'Actions'
        },
      ...
      dataExportConfirmMessage: 'The exported data contains sensitive account information. Store it securely.',
      ...
      dataImportWarning: 'Import will create new accounts/proxies; configure the default proxy and groups before importing. Ensure existing data does not conflict.',
      dataImportBindingTitle: 'Import bindings',
      dataImportBindingHint: 'File proxy mappings take priority. Accounts without a file mapping use the default proxy; selected groups apply to this import.',
      dataImportProxy: 'Default proxy',
      dataImportProxyHint: 'Accounts without a file proxy mapping use this proxy. Select No Proxy to keep them unbound.',
      dataImportGroupsHint: 'Only groups compatible with every account platform in the selected files are shown. Leave empty to keep accounts unbound.',
      dataImportProxySummary: '{mapped} account(s) use file proxy mappings; {unmapped} have no file mapping. File mappings take priority.',
      dataImportNoProxyConfirmMessage: 'File proxy mappings take priority. {count} account(s) have neither a file proxy mapping nor a default proxy and will connect directly.',
      bindingProxy: 'Proxy binding',
      bindingGroups: 'Group binding',
      bindingNoProxy: 'No proxy selected; direct connection',
      bindingGroupsSelected: '{count} group(s) selected',
      bindingUngroupedWarning: 'Will remain ungrouped',
      noProxyConfirmTitle: 'Continue without a proxy?',
      noProxyCreateConfirmMessage: 'No proxy is selected for this account. Continuing will use a direct connection.',
      returnToProxySelection: 'Back to proxy selection',
      continueWithoutProxy: 'Continue without proxy',
      ...
      workbenchNavigatorTitle: 'Account workbench',
      workbenchOperations: 'Workbench operations',
      workbenchNavigatorSearch: 'Search batches or uploaders',
      workbenchSourceAxis: 'Source',
      workbenchUsageAxis: 'Runtime',
      workbenchTypeAxis: 'Account type',
      workbenchSubscriptionAxis: 'Subscription',
      workbenchAllSubscriptions: 'All subscriptions',
      workbenchNonSubscription: 'Non-subscription',
      workbenchAvailabilitySummary: '{in_use} in use / {available} available / {total} total',
      workbenchAccountRange: 'Account range',
      workbenchUploaderAndBatch: 'Uploaders and recent batches',
      workbenchUploaderStats: '{total} total · {in_use} in use · {available} available · {restricted} restricted · {faults} failed · {batches} batches',
      workbenchBatchStats: '{total} accounts · {in_use} in use · {available} available',
      workbenchUsageGroupNormal: 'Normal operation',
      workbenchUsageGroupRestricted: 'Currently restricted',
      workbenchUsageGroupStopped: 'Stopped and failed',
      workbenchUsageStatus: {
        all: 'All statuses',
        available: 'Available accounts',
        in_use: 'In use',
        idle_available: 'Idle and available',
        rate_limited: 'Rate limited (429)',
        auth_issue: 'Authentication issue (401)',
        billing_restricted: 'Billing restricted (402)',
        access_restricted: 'Access restricted (403)',
        banned: 'Banned',
        overloaded: 'Overload cooldown',
        temporary_failure: 'Temporary failure',
        expired_or_quota: 'Expired / quota exhausted',
      ...
      workbenchUploaderDisabled: 'Disabled',
      workbenchSchedulableCount: 'Schedulable {current}/{total}',
      workbenchAttentionCount: '{count} abnormal',
      workbenchBatchCount: '{count} batches',
      workbenchRecentBatches: 'Recent batches',
      workbenchViewAllBatches: 'All batches',
      workbenchSortLabel: 'Sort accounts',
      workbenchSortNewest: 'Newest created',
      workbenchSortName: 'Account name',
      workbenchSortStatus: 'Account status',
      workbenchLoadMore: 'Load more',
      workbenchNavigatorEmpty: 'No matching results',
      searchLabel: 'Search',
      moreFilters: 'More filters',
      privacyLabel: 'Visibility',
      resultSummary: 'Current results: {accounts} accounts / {batches} batches',
      notes: 'Notes',
      ...
      importBatchSchedulable: 'Schedulable {current}/{total}',
      standaloneImport: 'Single import',
      ...
      allPrivacyModes: 'All visibility',
      privacyUnset: 'Unset',
      ...
      bulkActions: {
        ...
        selectedScope: '{count} accounts selected / {batches} batches',
        ...
        edit: 'Bulk Edit',
        editFiltered: 'Edit current {count} results',
        delete: 'Bulk Delete',
      ...
      usageWindow: {
        ...
        windowTooltip: '{window} window, {percent}% used, resets at {reset}',
