export default {
  sharedPool: {
    ...
    settlement: {
      title: '当前账号 AA', formula: '账号内保留完整分摊，按成员净额与结算人合并为单笔转账', usageWeight: '计价用量', totalCost: '本期成本', carryForward: '结转', coverage: '计价覆盖率', unpricedWarning: '存在 {count} 条未计价用量，当前分摊金额可能不完整。', payable: '应付', receivable: '应收', balanced: '无需转账',
      transferPreview: '合并转账', transferWorkbench: 'AA 转账工作台', hubHint: '选定结算人后，每名成员最多一笔转账，账号分摊明细完整保留。', settlementUser: '结算人', pendingMembers: '待结清成员', pendingAmount: '待转金额', singleTransferHint: '一个成员、一个周期、一个币种，一次转账即可结清。', pendingSummary: '待办理 {count} 笔', allSettled: '本期已全部结清', transferList: '转账清单', transferDirection: '转账方向', transferAmount: '转账金额', pendingTransfer: '待转账', settled: '已结清', handleTransfer: '办理转账', payer: '付款人', payee: '收款人', allocationDetails: '账号分摊明细', copyTitle: 'AA 转账信息', copyTransfer: '复制转账信息', copied: '转账信息已复制', markTransferPaid: '已转账并结清', memberSettled: '该成员已结清',
