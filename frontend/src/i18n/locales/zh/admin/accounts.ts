export default {
    accounts: {
      ...
      dataExportIncludeProxies: '代理连接信息请在代理管理中提交审核，通过后单独导出。',
      dataImport: '导入',
      moreActions: '更多操作',
      dataActions: '数据操作',
      toolActions: '工具',
      viewColumns: '列显示',
      toolsDialog: { title: '工作台工具' },
      actionDialog: {
        title: '账号操作',
        common: '常用操作',
        maintenance: '账号维护',
        ...
        data: '数据与审批',
        danger: '危险操作',
        deleteHint: '删除会进入现有的二次确认流程，并明确展示账号影响。'
      },
      display: {
        title: '显示设置',
        view: '工作视图',
      ...
      dataExportConfirmMessage: '导出的数据包含账号敏感信息，请妥善保存。',
      ...
      dataImportWarning: '导入将创建新账号与代理；可在导入前配置默认代理和分组，请确认已有数据不会冲突。',
      dataImportBindingTitle: '导入绑定',
      dataImportBindingHint: '文件中的代理映射优先；未提供映射的账号使用默认代理，所选分组应用于本次导入。',
      dataImportProxy: '默认代理',
      dataImportProxyHint: '文件未提供代理映射的账号使用此代理；选择“无代理”则保留空绑定。',
      dataImportGroupsHint: '仅展示与所选文件全部账号平台兼容的分组；留空表示不绑定。',
      dataImportProxySummary: '文件代理映射 {mapped} 个，未映射 {unmapped} 个；文件映射优先。',
      dataImportNoProxyConfirmMessage: '文件代理映射优先；本次有 {count} 个账号既无文件代理映射，也未选择默认代理，将直接连接。',
      bindingProxy: '代理绑定',
      bindingGroups: '分组绑定',
      bindingNoProxy: '未选择代理，将直接连接',
      bindingGroupsSelected: '已选择 {count} 个分组',
      bindingUngroupedWarning: '将保持未分组',
      noProxyConfirmTitle: '确认不使用代理',
      noProxyCreateConfirmMessage: '当前账号未选择代理，继续后将直接连接。',
      returnToProxySelection: '返回选择代理',
      continueWithoutProxy: '继续且不使用代理',
      dataImportFile: '数据文件',
      ...
      workbenchNavigatorTitle: '账号工作台',
      workbenchOperations: '工作台操作',
      workbenchNavigatorSearch: '搜索批次或上传者',
      workbenchSourceAxis: '来源',
      workbenchUsageAxis: '运行',
      workbenchTypeAxis: '账号类型',
      workbenchSubscriptionAxis: '订阅',
      workbenchAllSubscriptions: '全部订阅',
      workbenchNonSubscription: '非订阅账号',
      workbenchAvailabilitySummary: '使用中 {in_use} / 可用 {available} / 总计 {total}',
      workbenchAccountRange: '账号范围',
      workbenchUploaderAndBatch: '上传者与近期批次',
      workbenchUploaderStats: '总数 {total} · 使用中 {in_use} · 可用 {available} · 受限 {restricted} · 故障 {faults} · {batches} 个批次',
      workbenchBatchStats: '{total} 个账号 · 使用中 {in_use} · 可用 {available}',
      workbenchUsageGroupNormal: '正常运行',
      workbenchUsageGroupRestricted: '当前受限',
      workbenchUsageGroupStopped: '停止与故障',
      workbenchUsageStatus: {
        all: '全部状态',
        available: '可用账号',
        in_use: '使用中',
        idle_available: '空闲可用',
        rate_limited: '限流中 429',
        auth_issue: '鉴权问题 401',
        billing_restricted: '付费受限 402',
        access_restricted: '访问受限 403',
        banned: '已封禁',
        overloaded: '过载冷却',
        temporary_failure: '临时故障',
        expired_or_quota: '已过期 / 配额耗尽',
        other_error: '其他错误',
        ready: '可用待命',
        unused: '从未使用',
        attention: '需处理',
      ...
      workbenchUploaderDisabled: '已停用',
      workbenchSchedulableCount: '可调度 {current}/{total}',
      workbenchAttentionCount: '{count} 个异常',
      workbenchBatchCount: '{count} 个批次',
      workbenchRecentBatches: '最近批次',
      workbenchViewAllBatches: '全部批次',
      workbenchSortLabel: '账号排序',
      workbenchSortNewest: '最新创建',
      workbenchSortName: '账号名称',
      workbenchSortStatus: '账号状态',
      workbenchLoadMore: '加载更多',
      workbenchNavigatorEmpty: '没有匹配结果',
      searchLabel: '搜索',
      moreFilters: '更多筛选',
      privacyLabel: '可见范围',
      resultSummary: '当前结果：{accounts} 个账号 / {batches} 个批次',
      notes: '备注',
      ...
      importBatchSchedulable: '可调度 {current}/{total}',
      standaloneImport: '单独导入',
      ...
      usageWindow: {
        ...
        windowTooltip: '{window} 窗口，已用 {percent}%，重置时间：{reset}',
