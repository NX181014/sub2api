...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	out := &Account{
		...
		ContributorUserID:       a.ContributorUserID,
		...
		PoolRemainingCostMinor:  a.PoolRemainingCostMinor,
		PoolCostProgress:        a.PoolCostProgress,
		PoolLifecycleStatus:     a.PoolLifecycleStatus,
